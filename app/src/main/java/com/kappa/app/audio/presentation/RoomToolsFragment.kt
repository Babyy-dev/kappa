                ...
                when (seat.status) {
                    ...
                    SeatStatus.REQUESTED -> {
                        com.google.android.material.dialog.MaterialAlertDialogBuilder(requireContext())
                            .setTitle("Seat request")
                            .setMessage("Approve or reject this seat request?")
                            .setPositiveButton("Approve") { _, _ ->
                                audioViewModel.approveSeatRequest(seat.seatNumber)
                            }
                            .setNegativeButton("Reject") { _, _ ->
                                audioViewModel.rejectSeatRequest(seat.seatNumber)
                            }
