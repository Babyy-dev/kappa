...
interface ApiService {
    ...
    suspend fun verifyGooglePlayPurchase(
        @Body request: GooglePlayVerifyRequestDto
    ): BaseApiResponse<CoinPurchaseDto>
    ...
    @GET("home/posts")
    suspend fun getHomePosts(): BaseApiResponse<List<HomePostDto>>
    ...
    @POST("rooms/{id}/seats/{seat}/approve")
    suspend fun approveSeatRequest(@Path("id") id: String, @Path("seat") seat: Int): BaseApiResponse<Unit>

    @POST("rooms/{id}/seats/{seat}/reject")
    suspend fun rejectSeatRequest(@Path("id") id: String, @Path("seat") seat: Int): BaseApiResponse<Unit>
    ...
    suspend fun getAdminWithdrawalRules(): BaseApiResponse<AdminWithdrawalRulesDto?>

    @POST("admin/config/withdrawals")
    suspend fun setAdminWithdrawalRules(@Body request: AdminWithdrawalRulesDto): BaseApiResponse<AdminWithdrawalRulesDto>
